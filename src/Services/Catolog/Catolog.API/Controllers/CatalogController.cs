...
namespace Catolog.API.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        [HttpGet]
        [ProducesResponseType(typeof(IEnumerable<Product>), (int)HttpStatusCode.OK)]
        public async Task<ActionResult<IEnumerable<Product>>> GetProductByCatogoryName(string catogory)
        {
            var products = await _repository.GetProductByCategory(catogory);
            return Ok(products);
        }
